package fr.antoinerochas.nickreloaded.api.updater;
...
public class NickReloadedUpdater
{
    ...
    private NickReloadedUpdater.UpdateResult result = NickReloadedUpdater.UpdateResult.DISABLED;
    ...
    public NickReloadedUpdater(JavaPlugin plugin, Integer resourceId, boolean disabled)
    {
