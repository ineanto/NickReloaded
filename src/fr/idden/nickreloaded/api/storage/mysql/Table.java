...
public class Table
{
    ...
    public Table(DatabaseImpl database, String name)
    {
    ...
    {
        return requestHandler.select(Method.SELECT.getName() + " `" + field + "` " + Method.FROM.getName() + quotesName + Method.WHERE.getName() + where.getParsedNameAndValue(),
                                     field);
    }
    ...
    {
        return requestHandler.select(Method.SELECT.getName() + " `" + field + "` " + Method.FROM.getName() + quotesName + Method.WHERE.getName() + requestHandler.getListOfWhereValues(where),
                                     field);
    }
    ...
    {
        return requestHandler.selectList(Method.SELECT.getName() + " `" + field + "` " + Method.FROM.getName() + quotesName,
                                         field);
    }
    ...
    {
        return requestHandler.selectList(Method.SELECT.getName() + " `" + field + "` " + Method.FROM.getName() + quotesName + Method.WHERE.getName() + where.getParsedNameAndValue(),
                                         field);
    }
    ...
    {
        return requestHandler.selectList(Method.SELECT.getName() + " `" + field + "` " + Method.FROM.getName() + quotesName + Method.WHERE.getName() + requestHandler.getListOfWhereValues(where),
                                         field);
    }
    ...
    public void insert(Map<String, Object> fields)
    {
        ...
        {
            field.append("`").append(entry.getKey()).append("`, ");
            setter.append("'").append(entry.getValue()).append("', ");
        }

        //Update query
        requestHandler.executeUpdate(Method.INSERT_INTO.getName() + quotesName + "(" + field.substring(0,
                                                                                                       field.length() - 2) + ") " + Method.VALUES.getName() + "(" + setter.substring(0,
                                                                                                                                                                                     setter.length() - 2) + ")");
    }
    ...
    {
        requestHandler.executeUpdate(Method.UPDATE.getName() + quotesName + Method.SET.getName() + toSet.getParsedNameAndValue() + Method.WHERE.getName() + where.getParsedNameAndValue());
    }
    ...
    public void update(Map<String, Object> toSet, Field where)
    {
        ...
        //Update query
        requestHandler.executeUpdate(Method.UPDATE.getName() + quotesName + Method.SET.getName() + setters.substring(0,
                                                                                                                     setters.length() - 2) + Method.WHERE.getName() + where.getParsedNameAndValue());
    }
}
